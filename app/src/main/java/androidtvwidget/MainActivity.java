...
import androidtvwidget.view.MainLayout;
import androidtvwidget.view.MainUpView;
...
public class MainActivity extends Activity implements OnFocusChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		main_lay11.getViewTreeObserver().addOnGlobalFocusChangeListener(
				new OnGlobalFocusChangeListener() {//当在一个视图树中的焦点状态发生改变时，所要调用的回调函数的接口类
					@Override
